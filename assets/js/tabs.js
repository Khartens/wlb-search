...
class Tabs {
    constructor(selector, options) {
      ...
      this.tabs = document.querySelector(`[data-tabs="${selector}"]`); // tabs-product - если не будет рабоаать то сюжа переместить дату
      if (this.tabs) {
  ...
  let man = document.querySelector('.man');
    function fadeIn () {
      ...
      man.classList.add('fade-in');
      setTimeout(function() {
        man.classList.remove('fade-in');
      }, 1000);
    }